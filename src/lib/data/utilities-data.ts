...
export const UTILITIES: UtilityInfo[] = [
  ...
  },
  {
    ...
    status: 'coming-soon',
    features: [
      'IDE-native architecture validation',
      'Real-time schema autocompletion',
      'Architecture diagram generation from IDE',
      'Cross-tool context sharing via MCP protocol',
      'Works with VS Code, JetBrains, and Cursor',
      'Local and remote server modes',
    ],
  },
];
